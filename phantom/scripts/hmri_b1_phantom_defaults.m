...
% b0&b1-processing
hmri_def.b1map.i3D_EPI.b1proc.T1 = 1000; % ms, T1 of phantom at 3T
...
hmri_def.b1map.i3D_EPI.b1proc.B1FWHM = 0; % For smoothing of B1 map. FWHM in mm - i.e. it is divided by voxel resolution to get FWHM in voxels
hmri_def.b1map.i3D_EPI.b1proc.match_vdm = 1;
hmri_def.b1map.i3D_EPI.b1proc.b0maskbrain = false;
% b1-validation
